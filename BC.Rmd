...
# tmp = aggregate(avg ~ (round+round2)*as.factor(size)-1, data=amt)
tmp$fit = pred$fit
...
legend("topright", c('AMT (n=2, N=100)', 'AMT (n=4, N=92)', 'AMT (n=8, N=104)'), 
       bty='n', pch=c(4,4,4,1,2,3,6,5,0),
       col=c("#e74c3c","orange","#4575b4","black","black","black","black","black","black"), ncol=2)
```
